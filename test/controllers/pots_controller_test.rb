...
class PotsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pot" do
    assert_difference('Pot.count') do
      post pots_url, params: { pot: { finished: @pot.finished, inventory_status: @pot.inventory_status } }
    end
  ...
  test "should update pot" do
    patch pot_url(@pot), params: { pot: { finished: @pot.finished, inventory_status: @pot.inventory_status } }
